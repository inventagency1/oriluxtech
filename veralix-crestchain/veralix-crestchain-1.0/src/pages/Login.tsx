...
import { Gem, Mail, Lock, ArrowLeft } from "lucide-react";
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-sm sm:text-base text-muted-foreground">
            Accede a tu panel de certificación
          </p>
        </div>
        ...
        <Card className="shadow-premium border-border/50">
          <CardHeader className="text-center pb-4 sm:pb-6">
            ...
            <CardDescription className="text-xs sm:text-sm">
              Ingresa a tu cuenta de joyería
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-3 sm:space-y-4">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <Link 
                  to="/forgot-password" 
                  className="text-primary hover:text-primary-dark transition-fast"
                >
            ...
            <div className="text-center text-sm mt-4">
              <Link 
                to="/forgot-password" 
                className="text-veralix-gold hover:text-veralix-gold-light transition-fast"
              >
                ¿Olvidaste tu contraseña?
              </Link>
            </div>
